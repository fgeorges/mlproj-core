...
t.test('Parsing cat - schema, security and triggers dbs', ass => {
    ...
    ass.database('The schema db',   dbs[0], null, 'simple-cat-schema',   []);
    ass.database('The security db', dbs[1], null, 'simple-cat-security', []);
    ass.database('The triggers db', dbs[2], null, 'simple-cat-triggers', []);
    ass.database('The content db',  dbs[3], null, 'simple-cat-content',  [],
